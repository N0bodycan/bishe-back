...
public class GlobalExceptionController {
 ...
 @ExceptionHandler(KrestTokenException.class)
 public ResponseEntity KrestTokenExceptionHandler(KrestTokenException e){
     log.error("TokenExceptionHandler");
     log.error(e.getLocalizedMessage());

     Map<String,Object> body=new HashMap<String,Object>();
     body.put("status", HttpStatus.UNAUTHORIZED.value());//也可以自定义更详细的状态码
     body.put("code", -1);
     body.put("message",e.getLocalizedMessage());
     body.put("exception",e.getClass().getName());
